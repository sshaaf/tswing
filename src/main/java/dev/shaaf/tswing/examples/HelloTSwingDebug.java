...
/**
 * Debug version of HelloTSwing with console output
 */
public class HelloTSwingDebug {
    ...
    public static void main(String[] args) {
        ...
        clickButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                clickCount++;
                System.err.println("DEBUG: ActionListener called! Count: " + clickCount);
                String newText = "Button clicked " + clickCount + " time(s)!";
                System.err.println("DEBUG: Setting text to: " + newText);
                descLabel.setText(newText);
                System.err.println("DEBUG: Text set. Label text is now: " + descLabel.getText());
            }
        });
